...
id: Filament_Sensor_Simplified
title: Filament sensor simplified
description: Simple plugin reacting to filament sensor, issuing M600 (filament change) command to printer
...
http://plugins.octoprint.org/plugin/Filament_Sensor_Simplified/
